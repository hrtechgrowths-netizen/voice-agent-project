...
# 2. FIXED: Catch internal crashes and force CORS headers so the actual Python error shows in your browser console instead of a fake CORS block!
@app.exception_handler(Exception)
async def global_exception_handler(request: Request, exc: Exception):
    return JSONResponse(
        status_code=500,
        content={"error": "Backend Internal Crash", "details": str(exc)},
        headers={
